...
function Reward() {
  ...
  const [tableHead, tableHeadSet] = useState([
    ...
    { Header: "Nama Reward", accessor: "name", width: "25%" },
    { Header: "Harga", accessor: "amount", width: "25%" },
    { Header: "Jumlah Poin", accessor: "point", width: "25%" },
    { Header: "Minimal Kaki", accessor: "minFoot", width: "25%" },
  ...
  const loadData = (params) => {
    ...
    useAxios()
      .post(`${Config.ApiUrl}/api/v1/master/reward/list`, payload)
      .then((response) => {
